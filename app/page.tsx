...
const TOOLKIT: ToolkitItem[] = [
  ...
  { name: 'Webhooks',         abbr: 'Wh',  color: '#c9a876', bg: 'rgba(201,168,118,0.10)', src: '/icons/webhookicon.svg' },
  ...
  { name: 'API Integration',  abbr: 'API', color: '#c9a876', bg: 'rgba(201,168,118,0.10)' },
]
